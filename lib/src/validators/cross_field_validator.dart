...
class CrossFieldValidators {
  CrossFieldValidators._(); // Private constructor to prevent instantiation
  ...
  static CrossFieldValidator<T> matches<T>(
  ...
  /// [errorText] overrides the localized error message if provided.
  static CrossFieldValidator<T> differentFrom<T>(
  ...
  /// [errorText] overrides the localized error message if provided.
  static CrossFieldValidator<T> requiredWhen<T>(
  ...
  /// [dependentFieldName] is the name of the field to check.
  /// [errorText] overrides the localized error message if provided.
  static CrossFieldValidator<T> requiredWhenNotEmpty<T>(
    String dependentFieldName, {
    String? errorText,
  }) {
    return CrossFieldValidator<T>(
  ...
  /// [errorText] overrides the localized error message if provided.
  static CrossFieldValidator<DateTime> dateBefore(
  ...
  /// [errorText] overrides the localized error message if provided.
  static CrossFieldValidator<DateTime> dateAfter(
  ...
  /// [errorText] overrides the localized error message if provided.
  static CrossFieldValidator<num> greaterThan(
    String minFieldName, {
    String? errorText,
  }) {
  ...
  /// [errorText] overrides the localized error message if provided.
  static CrossFieldValidator<num> lessThan(
    String maxFieldName, {
    String? errorText,
  }) {
    return CrossFieldValidator<num>(
  ...
  /// [errorText] overrides the localized error message if provided.
  static CrossFieldValidator<num> sumCondition(
  ...
  /// [errorText] overrides the localized error message if provided.
  static CrossFieldValidator<T> atLeastOneRequired<T>(
    List<String> fieldNames, {
    String? errorText,
  }) {
    return CrossFieldValidator<T>(
