...
import 'package:typed_form_fields/src/validators/common_validators.dart';
  ...
  group('CommonValidators', () {
    group('required', () {
      ...
      test('should return error for empty list', () {
        final validator = CommonValidators.required<List<String>>();
        expect(validator.validate(<String>[], mockContext),
            'This field is required.');
      });

      test('should return error for empty map', () {
        final validator = CommonValidators.required<Map<String, String>>();
      ...
      test('should return null for valid number', () {
        final validator = CommonValidators.required<int>();
    ...
    group('email', () {
      ...
      test('should use custom error text', () {
        final validator =
            CommonValidators.email(errorText: 'Custom email error');
        expect(
    ...
    group('minLength', () {
      ...
      test('should use custom error text', () {
        final validator = CommonValidators.minLength(5, errorText: 'Too short');
    ...
    group('maxLength', () {
      ...
      test('should use custom error text', () {
        final validator = CommonValidators.maxLength(5, errorText: 'Too long');
    ...
    group('pattern', () {
      test('should return error for non-matching pattern', () {
        final validator = CommonValidators.pattern(RegExp(r'^\d+$'));
        expect(validator.validate('abc', mockContext),
    ...
    group('numeric', () {
      test('should return error for non-numeric string', () {
        final validator = CommonValidators.numeric();
        expect(validator.validate('abc', mockContext),
      ...
      test('should use custom error text', () {
        final validator = CommonValidators.numeric(errorText: 'Invalid number');
    ...
    group('min', () {
      test('should return error for value less than minimum', () {
        final validator = CommonValidators.min(10);
    ...
    group('max', () {
      test('should return error for value greater than maximum', () {
        final validator = CommonValidators.max(10);
    ...
    group('url', () {
      ...
      test('should use custom error text', () {
        final validator = CommonValidators.url(errorText: 'Invalid URL format');
        expect(
    ...
    group('phoneNumber', () {
      test('should return error for invalid phone number', () {
        final validator = CommonValidators.phoneNumber();
        expect(validator.validate('abc', mockContext),
      ...
      test('should use custom error text', () {
        final validator =
            CommonValidators.phoneNumber(errorText: 'Invalid phone');
    ...
    group('creditCard', () {
      test('should return error for invalid credit card', () {
        final validator = CommonValidators.creditCard();
        expect(validator.validate('123', mockContext),
      ...
      test('should use custom error text', () {
        final validator =
            CommonValidators.creditCard(errorText: 'Invalid card');
    ...
    group('dateString', () {
      test('should return error for invalid date', () {
        final validator = CommonValidators.dateString();
      ...
      test('should use custom error text', () {
        final validator =
            CommonValidators.dateString(errorText: 'Invalid date format');
        expect(
    ...
    group('ipAddress', () {
      test('should return error for invalid IP', () {
        final validator = CommonValidators.ipAddress();
      ...
      test('should use custom error text', () {
        final validator = CommonValidators.ipAddress(errorText: 'Invalid IP');
    ...
    group('uuid', () {
      test('should return error for invalid UUID', () {
        final validator = CommonValidators.uuid();
      ...
      test('should use custom error text', () {
        final validator =
            CommonValidators.uuid(errorText: 'Invalid UUID format');
        expect(
    ...
    group('json', () {
      test('should return error for invalid JSON', () {
        final validator = CommonValidators.json();
      ...
      test('should use custom error text', () {
        final validator =
            CommonValidators.json(errorText: 'Invalid JSON format');
        expect(
    ...
    group('alphanumeric', () {
      test('should return error for non-alphanumeric characters', () {
        final validator = CommonValidators.alphanumeric();
    ...
    group('alphabetic', () {
      test('should return error for numbers', () {
        final validator = CommonValidators.alphabetic();
        expect(validator.validate('abc123', mockContext),
      ...
      test('should use custom error text', () {
        final validator =
            CommonValidators.alphabetic(errorText: 'Letters only');
